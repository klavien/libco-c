...
typedef struct stTimeoutItemLink_t stTimeoutItemLink_t;
typedef struct stCoSpec_t stCoSpec_t;
typedef struct stStackMem_t stStackMem_t;
typedef struct stShareStack_t stShareStack_t;
typedef struct stCoRoutine_t stCoRoutine_t;
typedef struct stCoRoutineAttr_t stCoRoutineAttr_t;
typedef struct stCoSpec_t stCoSpec_t;
typedef struct stCoEpoll_t stCoEpoll_t;
typedef struct stCoRoutineEnv_t stCoRoutineEnv_t;
typedef struct stCoCond_t stCoCond_t;
typedef struct coctx_t coctx_t;
typedef struct stRoutineArgs_t stRoutineArgs_t;
typedef int (*pfn_co_eventloop_t)(void *);
void co_eventloop_( stCoEpoll_t *ctx,pfn_co_eventloop_t pfn,void *arg, int once_flag);
